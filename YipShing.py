...
def generate_overview_pdf(specs, project_info, qty):
    ...
    doc = SimpleDocTemplate(
        buffer,
        pagesize=landscape(letter),   # 維持橫向
        rightMargin=25,
        leftMargin=25,
        topMargin=20,
        bottomMargin=25
