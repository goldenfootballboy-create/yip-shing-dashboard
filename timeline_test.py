...
if total > 0:
    ...
    for _, row in display_df.iterrows():
        ...
        # Cleaning (10%)
        met['cleaning'] = str(row['Cleaning']).strip().upper() == 'YES' if pd.notna(row['Cleaning']) else False
        ...
        # Explanation
        exp = {0: "Not Start", 30: "Parts Arrived", 70: "Installation Completed",
               80: "Testing Completed", 90: "Cleaning Completed", 100: "Project Completed"}.get(progress, f"{progress}% Progress")
