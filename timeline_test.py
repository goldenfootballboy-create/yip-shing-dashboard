...
def render_project_card(row, idx):
    ...
    if "kta38" in project_spec:
        reminder_text = "KTA38"
        reminder_display = f'<div style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-weight:bold; font-size:1.2rem; color:#00ffff; text-shadow: 0 0 10px #00ffff, 0 0 20px #00ffff, 0 0 30px #00ffff; font-family: \'Orbitron\', monospace; letter-spacing: 3px; pointer-events:none; z-index:10;">{reminder_text}</div>'
    else:
