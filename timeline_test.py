...
# -------------------------------------------------
# 5. 主畫面：左邊專案列表 + 右邊 Checklist 面板
# -------------------------------------------------
if total_real_count > 0:
    left_col, right_col = st.columns([7, 3])  # 左 70% 右 30%
    ...
    # -------------------------------------------------
    # 右邊：Checklist Panel（像左邊 Controls 一樣）
    # -------------------------------------------------
    with right_col:
        st.markdown("### 📋 Checklist Panel")
