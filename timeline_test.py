...
<style>
    ...
    .progress-wrapper {
        ...
        align-items: center;
        flex-grow: 1;
        padding-left: 5px; /* 與圖片和 Project Name 之間的間距 */
    }
    .custom-progress {
        height: 20px;
    ...
    .kta38-icon {
        ...
        margin-right: 5px; /* 與 Project Name 之間的間距 */
        vertical-align: middle;
    }
    .reminder-section {
...
if df is None:
    ...
    if total_projects > 0:
        ...
        for index, row in display_df.iterrows():
            ...
            col1, col2 = st.columns([0.5, 8.5])  # 圖片與 Project Name + 進度條的寬度分配
            with col1:
                if has_kta38:
